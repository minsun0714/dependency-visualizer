...
- **JDK 21+** — 플러그인이 Java 21 로 컴파일되므로 Gradle 을 실행하는 JVM 이 21 이상이어야 합니다.
...
plugins {
    java
    id("io.github.minsun0714.dependency-visualizer") version "0.1.1"
}
```
...
dependencyVisualizer {
    ...
    sourceRoot = file("src/main/java")            // 분석 소스 루트. 생략 시 main sourceSet
